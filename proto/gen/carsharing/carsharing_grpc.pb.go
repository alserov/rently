...
type CarsClient interface {
	...
	GetRentStartingTomorrow(ctx context.Context, in *GetRentStartingTomorrowReq, opts ...grpc.CallOption) (*GetRentStartingTomorrowRes, error)
...
func (c *carsClient) GetRentStartingTomorrow(ctx context.Context, in *GetRentStartingTomorrowReq, opts ...grpc.CallOption) (*GetRentStartingTomorrowRes, error) {
	out := new(GetRentStartingTomorrowRes)
	err := c.cc.Invoke(ctx, "/carsharing.Cars/GetRentStartingTomorrow", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CarsServer interface {
	...
	GetRentStartingTomorrow(context.Context, *GetRentStartingTomorrowReq) (*GetRentStartingTomorrowRes, error)
...
func (UnimplementedCarsServer) GetRentStartingTomorrow(context.Context, *GetRentStartingTomorrowReq) (*GetRentStartingTomorrowRes, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetRentStartingTomorrow not implemented")
}
...
func _Cars_GetRentStartingTomorrow_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetRentStartingTomorrowReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CarsServer).GetRentStartingTomorrow(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/carsharing.Cars/GetRentStartingTomorrow",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CarsServer).GetRentStartingTomorrow(ctx, req.(*GetRentStartingTomorrowReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Cars_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetRentStartingTomorrow",
			Handler:    _Cars_GetRentStartingTomorrow_Handler,
		},
		{
